...
--
-- Table structure for table `cursoreferencia_alumno`
--
...
CREATE TABLE `cursoreferencia_alumno` (
  ...
  KEY `refAlumno` (`refAlumno`),
  KEY `refLetraCurso` (`refLetraCurso`,`refAñoCurso`),
  CONSTRAINT `cursoreferencia_alumno_ibfk_1` FOREIGN KEY (`refAlumno`) REFERENCES `alumno` (`run`),
  CONSTRAINT `cursoreferencia_alumno_ibfk_2` FOREIGN KEY (`refLetraCurso`, `refAñoCurso`) REFERENCES `cursoreferencia` (`letra`, `año`)
